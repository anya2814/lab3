...
void ChartWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->drawChartSlot(); break;
        case 1: _t->dataReadFailedSlot((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 2: _t->PBprintPDFSlot(); break;
        case 3: _t->CBchartTypeSlot((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: _t->CBcolorSlot((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
